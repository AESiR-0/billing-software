...
// import loginHero from ' /src/static/images/login-hero.jpg'
        ...
        <section className="h-screen">
            ...
            <!-- Left column container with background--> */}
                    <div className="mb-12 md:mb-0 md:w-8/12 lg:w-6/12">
                        <img src='/static/images/login-hero.jpg'
            ...
            <!-- Right column container with form --> */}
                    <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                        ...
                        <form className="flex flex-col gap-10">
                            {/*
                    <!-- Email input --> */}
                            <input type="email" label="Email address" size="lg" className="border p-2 rounded" placeholder='Enter Email'></input>

                            {/*
                    <!--Password input--> */}
                            <input type="password" label="Password" className="border p-2 rounded" placeholder='Enter Password' size="lg"></input>
